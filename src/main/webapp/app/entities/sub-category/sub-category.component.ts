...
export default class SubCategory extends Vue {
  ...
  public retrieveAllSubCategorys(): void {
  ...
  public prepareRemove(instance: ISubCategory): void {
  ...
  public removeSubCategory(): void {
    this.subCategoryService()
      ...
      .then(() => {
        const message = this.$t('elonlarApp.subCategory.deleted', { param: this.removeId });
