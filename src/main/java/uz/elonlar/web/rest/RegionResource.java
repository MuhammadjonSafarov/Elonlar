...
/**
 * REST controller for managing {@link uz.elonlar.domain.Region}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RegionResource {
    ...
    public ResponseEntity<Region> partialUpdateRegion(
        ...
        Optional<Region> result = regionRepository
            ...
            .map(existingRegion -> {
                if (region.getNameUzLat() != null) {
                    existingRegion.setNameUzLat(region.getNameUzLat());
                }
                if (region.getNameUzKr() != null) {
                    existingRegion.setNameUzKr(region.getNameUzKr());
                }
                if (region.getNameRu() != null) {
                    existingRegion.setNameRu(region.getNameRu());
                }
                if (region.getNameEn() != null) {
                    existingRegion.setNameEn(region.getNameEn());
                }
