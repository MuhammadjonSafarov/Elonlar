...
/**
 * REST controller for managing {@link uz.elonlar.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Category> partialUpdateCategory(
        ...
        Optional<Category> result = categoryRepository
            ...
            .map(existingCategory -> {
                if (category.getNameUzLat() != null) {
                    existingCategory.setNameUzLat(category.getNameUzLat());
                }
                if (category.getNameUzKr() != null) {
                    existingCategory.setNameUzKr(category.getNameUzKr());
                }
                if (category.getNameRu() != null) {
                    existingCategory.setNameRu(category.getNameRu());
                }
                if (category.getNameEn() != null) {
                    existingCategory.setNameEn(category.getNameEn());
                }
