...
/**
 * REST controller for managing {@link uz.elonlar.domain.SubCategory}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<SubCategory> partialUpdateSubCategory(
        ...
        Optional<SubCategory> result = subCategoryRepository
            ...
            .map(existingSubCategory -> {
                if (subCategory.getNameUzLat() != null) {
                    existingSubCategory.setNameUzLat(subCategory.getNameUzLat());
                }
                if (subCategory.getNameUzKr() != null) {
                    existingSubCategory.setNameUzKr(subCategory.getNameUzKr());
                }
                if (subCategory.getNameRu() != null) {
                    existingSubCategory.setNameRu(subCategory.getNameRu());
                }
                if (subCategory.getNameEn() != null) {
                    existingSubCategory.setNameEn(subCategory.getNameEn());
                }
